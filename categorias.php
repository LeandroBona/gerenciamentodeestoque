  ...
  <body>
   <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
    ...
    <main class="container mt-4">
      ...
      <div class="col-md-12">
        <form action="./backend/create_categorias.php" method="POST">
          <div class="mb-3">
                ...
                <?php
                    ...
                    if($resultado->num_rows > 0){
                        ...
                        while($linha = $resultado->fetch_assoc()){
                            ...
                            echo "<td> <a href='backend/delete_categorias.php?id=" . $linha['id_categoria'] . "&table=categoria' class='bnt btn-danger' ><i class= 'bi bi-trash3' ></i>excluir</a>";
                            echo "<td>
                            <button 
                                type='button' 
      ...
      <form action="backend/update-categoria.php" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="categoria" id="edit-name">
          </div>
        </div>
